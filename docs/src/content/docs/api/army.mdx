...
| priorityCell | `string?` | Optional fallback cell for players when there are more army members than available cells, or when the cells array is empty. Acts as an overflow destination. |
