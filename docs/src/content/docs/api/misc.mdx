...
| Parameter | Type | Description |
|-----------|------|-------------|
| username | `string` \| `null` | The username of the account. If set to null, the current username (as shown to the bot) will be used. |
| password | `string` \| `null` | The password of the account. If set to null, the current password (as shown to the bot) will be used. |
| server | `string` \| `null` | The server to log into. If set to null, the current server will be used. |
