...
Type: [`ShopInfo`](/api-legacy/typedefs/shopinfo) \| `null`
...
| Parameter | Type | Description |
|-----------|------|-------------|
| shopItemId | `string` \| `number` | The ShopItemID of the item. |
| quantity | `number` | The quantity to buy. |
...
**Returns**: [`ShopItem`](/api-legacy/models/shopitem) \| `null`
