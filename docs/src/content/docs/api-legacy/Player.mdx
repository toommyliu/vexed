...
Type: [`Faction`](/api-legacy/models/faction)[]
...
### hpPercentage <Badge text="Getter" size="small" />	
...
### mpPercentage <Badge text="Getter" size="small" />	
...
|-----------|------|-------------|
| type | [`BoostType`](/api-legacy/enums/boosttype) | The type of boost to check. |
