...
| skillAction | `(() => () => Promise<void>)` \| `null` | Custom skill action function. If provided, the skillSet and skillDelay will be ignored. Recommended to be a closure function. |
