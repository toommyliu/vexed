...
### autoRegisterRequirements <Badge text="Getter" size="small" />	 <Badge text="Setter" size="small" />
Gets the auto register requirements flag.

Type: `boolean`

### autoRegisterRewards <Badge text="Getter" size="small" />	 <Badge text="Setter" size="small" />
...
### questItemIds <Badge text="Getter" size="small" />	
