...
|-------|------|-------------|
| `SafeClass` | `string` | Safe class to equip first (prevents class skill conflicts) |
| `SafePot` | `string` | Consumable to equip before/after class swap (protects potion slot) |
| `Class` | `string` | Combat class to use |
