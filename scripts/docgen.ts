...
const renderIndex = (namespaces: readonly ApiNamespace[]): string => {
  const lines = [
    ...
    ...namespaces.map(
      (namespace) =>
        `| [\`api.${namespace.name}\`](/scripting/api/${namespace.slug}/) | \`${namespace.sourceType}\` |`,
    ),
  ];
...
const renderFiles = (
  ...
  return [
    ...
    },
    {
      ...
      content: renderApiOverview(helpers, namespaces, typeLinks),
    },
    {
