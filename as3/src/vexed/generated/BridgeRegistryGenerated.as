...
package vexed.generated
{
  ...
  public class BridgeRegistryGenerated
  {
    public static function register(external:Externalizer):void
    {
      ...
      external.externalize("settings.lagKiller", Settings.lagKiller);
      external.externalize("settings.provokeCell", Settings.provokeCell);
      external.externalize("settings.setAccessLevel", Settings.setAccessLevel);
      external.externalize("settings.setDeathAds", Settings.setDeathAds);
      external.externalize("settings.setDisableCollisions", Settings.setDisableCollisions);
      external.externalize("settings.setDisableFX", Settings.setDisableFX);
      external.externalize("settings.setFPS", Settings.setFPS);
      external.externalize("settings.setGuild", Settings.setGuild);
      external.externalize("settings.setHidePlayers", Settings.setHidePlayers);
      external.externalize("settings.setName", Settings.setName);
      ...
      external.externalize("world.dumpMonsters", World.dumpMonsters);
      external.externalize("world.getCellMonsters", World.getCellMonsters);
      ...
      external.externalize("world.getPlayer", World.getPlayer);
      external.externalize("world.getPlayerNames", World.getPlayerNames);
      external.externalize("world.getPlayers", World.getPlayers);
      external.externalize("world.getRoomId", World.getRoomId);
      external.externalize("world.getRoomNumber", World.getRoomNumber);
      external.externalize("world.isActionAvailable", World.isActionAvailable);
      external.externalize("world.isLoaded", World.isLoaded);
      external.externalize("world.isPlayerInCell", World.isPlayerInCell);
