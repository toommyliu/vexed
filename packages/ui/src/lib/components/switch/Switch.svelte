...
>
    <span
        class={cn(
            "pointer-events-none block h-5 w-5 rounded-full bg-background shadow-md ring-0 transition-all duration-200 data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0",
        )}
        data-state={checked ? "checked" : "unchecked"}
    ></span>
</button>
