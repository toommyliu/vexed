...
>
  <input
    class={cn(
      "w-full min-w-0 rounded-[inherit] bg-transparent px-[calc(theme(spacing.3)-1px)] py-[calc(theme(spacing[1.5])-1px)] outline-none placeholder:text-muted-foreground/64 placeholder:text-sm",
      size === "sm" &&
