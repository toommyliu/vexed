...
<span
  class={cn(
    !unstyled &&
      "relative inline-flex w-full rounded-lg border border-input bg-background bg-clip-padding text-base/5 shadow-xs ring-ring/24 transition-shadow before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(theme(borderRadius.lg)-1px)] not-has-[:disabled]:not-has-[:focus-visible]:not-has-[aria-invalid]:before:shadow-[0_1px_theme(colors.black/4%)] has-[:focus-visible]:has-[aria-invalid]:border-destructive/64 has-[:focus-visible]:has-[aria-invalid]:ring-destructive/16 has-[aria-invalid]:border-destructive/36 has-[:focus-visible]:border-ring has-[:disabled]:opacity-64 has-[:disabled]:shadow-none has-[:focus-visible]:shadow-none has-[aria-invalid]:shadow-none has-[:focus-visible]:ring-[3px] sm:text-sm dark:bg-input/32 dark:not-in-data-[slot=group]:bg-clip-border dark:has-[aria-invalid]:ring-destructive/24 dark:not-has-[:disabled]:not-has-[:focus-visible]:not-has-[aria-invalid]:before:shadow-[0_-1px_theme(colors.white/8%)]",
    className,
  ) || undefined}
  data-size={size}
