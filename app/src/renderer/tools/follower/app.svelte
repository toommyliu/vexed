  ...
  <div class="flex flex-1 items-center justify-center p-4">
    <div class="w-full space-y-6 px-2 sm:px-4">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div
          class="bg-background-secondary rounded-md border border-gray-800/50 p-6 backdrop-blur-sm"
        >
          <div class="space-y-4">
            <div class="space-y-3">
              <label
            ...
            <div class="space-y-3">
              <div class="flex items-center space-x-2">
                ...
                <input
                  ...
                  max="4"
                  class={cn(
                    "bg-background-secondary w-16 rounded-md border border-gray-700/50 px-2 py-1 text-center text-white transition-all duration-200 focus:border-blue-500/50 focus:outline-none",
                    isEnabled &&
                      "pointer-events-none cursor-not-allowed opacity-50",
                  )}
                  disabled={isEnabled}
